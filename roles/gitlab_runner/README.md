...
- gitlab_runner_url - url of the gitlab instance #define when writing playbook 
- gitlab_runner_token - runner authentication token (glrt-...) #define when writing playbook 
