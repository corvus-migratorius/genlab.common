...
- gitlab_runner_version - version of the gitlab-runner deb package to pin
- gitlab_runner_name - runner name shown in gitlab
- gitlab_runner_url - url of the gitlab instance, empty by default
- gitlab_runner_token - runner authentication token (glrt-...), empty by default
- gitlab_runner_certs_dir - directory that will contain ca-certificate for self-signed gitlab
- gitlab_runner_ca_fetch - pull the tls-certificate from gitlab and trust it
...
- gitlab_runner_docker_privileged - run job containers in privileged mode
